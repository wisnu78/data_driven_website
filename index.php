...
<head>
    ...
    <!--====== FAVICON ICON =======-->
    <link rel="shortcut icon" type="image/ico" href="front_page/img/favicon.png" />

    <!--====== STYLESHEETS ======-->
    <link rel="stylesheet" href="front_page/css/normalize.css">
    <link rel="stylesheet" href="front_page/css/animate.css">
    <link rel="stylesheet" href="front_page/css/modal-video.min.css">
    <link rel="stylesheet" href="front_page/css/stellarnav.min.css">
    <link rel="stylesheet" href="front_page/css/owl.carousel.css">
    <link rel="stylesheet" href="front_page/css/slick.css">
    <link href="front_page/css/bootstrap.min.css" rel="stylesheet">
    <link href="front_page/css/font-awesome.min.css" rel="stylesheet">
    <link href="front_page/css/material-icons.css" rel="stylesheet">

    <!--====== MAIN STYLESHEETS ======-->
    <link href="front_page/style.css" rel="stylesheet">
    <link href="front_page/css/responsive.css" rel="stylesheet">

    <script src="front_page/js/vendor/modernizr-2.8.3.min.js"></script>
    <!--[if lt IE 9]>
        <script src="front_page///oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
        <script src="front_page///oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
        <![endif]-->
</head>
...
<body class="home-one" data-spy="scroll" data-target=".mainmenu-area" data-offset="90">
    ...
    <!--[if lt IE 8]>
        <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="front_page/http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>
    <![endif]-->
    ...
    <!--SCROLL TO TOP-->
    <a href="front_page/#home" class="scrolltotop"><i class="fa fa-long-arrow-up"></i></a>
                ...
                <nav class="navbar">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a href="front_page/#home" class="navbar-brand"><img src="front_page/img/logo.png" alt="logo"></a>
                        </div>
                        <div id="main-nav" class="stellarnav">
                            <div class="search-and-signup-button white pull-right hidden-md hidden-sm hidden-xs">
                                ...
                                <a href="front_page/#" class="sign-up">SignUp</a>
                            </div>
                            <ul id="nav" class="nav">
                                <li class="active"><a href="front_page/#home">home</a>
                                    <ul>
                                        <li><a href="front_page/index.html"> Home Version 1</a></li>
                                        <li><a href="front_page/index-2.html"> Home Version 2</a></li>
                                        <li><a href="front_page/index-3.html"> Home Version 3</a></li>
                                    </ul>
                                </li>
                                <li><a href="front_page/#features">Features</a></li>
                                <li><a href="front_page/#app">App</a></li>
                                <li><a href="front_page/#video">Video</a></li>
                                <li><a href="front_page/#screenshot">Screenshot</a></li>
                                <li><a href="front_page/#team">Team</a></li>
                                <li><a href="front_page/#pricing">Pricing</a></li>
                                <li><a href="front_page/#contact">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                    ...
                    <div class="row flex-v-center">
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-mockup center">
                                <img src="front_page/img/home/watch-mockup.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-text">
                                ...
                                <div class="home-button">
                                    <a href="front_page/#">Get App Now</a>
                                    <a href="front_page/#">Discover More</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="qs-box relative mb50 center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <a href="front_page/#" class="read-more">Learn More</a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
            ...
            <div class="row flex-v-center">
                ...
                <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 ">
                    <div class="service-image text-center wow fadeIn">
                        <img src="front_page/img/mockups/work-area-mockup.png" alt="">
                    </div>
                </div>
                    ...
                    <div class="screenshot-slider-area wow fadeIn">
                        <div class="screenshot-slider">
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-1.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-2.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-3.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-4.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-5.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-6.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-7.jpg" alt="">
                            </div>
                            <div class="single-screenshot">
                                <img src="front_page/img/screenshot/screenshot-1.jpg" alt="">
                            </div>
                        ...
                        <div class="single-testmonial center">
                            <div class="testmonial-author-data">
                                <div class="author-image">
                                    <img src="front_page/img/testmonial/testmonial-1.jpg" alt="">
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="download-content sm-center xs-center xs-mb50 xs-font wow fadeIn">
                        ...
                        <a href="front_page/#" class="download-button"><i class="fa fa-apple"></i>Download On The <span>App Store</span></a>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4 col-sm-6 col-xs-12">
                    <div class="download-content sm-center xs-center wow fadeIn">
                        ...
                        <p>app download App store, It’s a long established fact that a reader will be distracted by the readable content....</p>
                        <a href="front_page/#" class="download-button"><i class="fa fa-play"></i>Get It On <span>Google Play</span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="team-member-thumb tab-content">
                        <div class="member-thumb member-one tab-pane fade in active">
                            <img src="front_page/img/team/team-1.png" alt="">
                        </div>
                        <div class="member-thumb member-two tab-pane fade">
                            <img src="front_page/img/team/team-2.png" alt="">
                        </div>
                        <div class="member-thumb member-three tab-pane fade">
                            <img src="front_page/img/team/team-3.png" alt="">
                        </div>
                        <div class="member-thumb member-four tab-pane fade">
                            <img src="front_page/img/team/team-4.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="team-member-details tab-content">
                        <div class="member-details-content xs-center member-one tab-pane fade in active">
                            ...
                            <ul class="social-bookmark mt50">
                                <li><a href="front_page/#"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="front_page/#"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="front_page/#"><i class="fa fa-linkedin"></i></a></li>
                                <li><a href="front_page/#"><i class="fa fa-google-plus"></i></a></li>
                                <li><a href="front_page/#"><i class="fa fa-skype"></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="team-member-thumb-menu">
                        <ul class="inline-blcok">
                            <li class="active"><a data-toggle="tab" href="front_page/.member-one"><img src="front_page/img/team/thumb-3.jpg" alt=""></a></li>
                            <li><a data-toggle="tab" href="front_page/.member-two"><img src="front_page/img/team/thumb-2.jpg" alt=""></a></li>
                            <li><a data-toggle="tab" href="front_page/.member-three"><img src="front_page/img/team/thumb-1.jpg" alt=""></a></li>
                            <li><a data-toggle="tab" href="front_page/.member-four"><img src="front_page/img/team/thumb-4.jpg" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-price center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="buy-now-button">
                            <a href="front_page/#" class="read-more">Purchase</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog mb30 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-thumb width100">
                            <a href="front_page/blog.html"><img src="front_page/img/blog/blog-1.jpg" alt=""></a>
                        </div>
                        <div class="blog-details padding-30 border">
                            <h4><a href="front_page/blog.html">Experience And Resources By Your Side.</a></h4>
                            <p class="blog-meta"><i class="material-icons">event_note</i> <a href="front_page/#">02 February 2016  </a> <i class="material-icons">group</i> <a href="front_page/#">Super User</a></p>
                            <p>Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel</p>
                            <a class="readmore" href="front_page/blog.html">Continue....</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog mb30 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-thumb width100">
                            <a href="front_page/blog.html"><img src="front_page/img/blog/blog-2.jpg" alt=""></a>
                        </div>
                        <div class="blog-details padding-30 border">
                            <h4><a href="front_page/blog.html">The Most Effective App For mobile</a></h4>
                            <p class="blog-meta"><i class="material-icons">event_note</i> <a href="front_page/#">02 February 2016  </a> <i class="material-icons">group</i> <a href="front_page/#">Super User</a></p>
                            <p>Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel</p>
                            <a class="readmore" href="front_page/blog.html">Continue....</a>
                        </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="single-blog mb30 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-thumb width100">
                            <a href="front_page/blog.html"><img src="front_page/img/blog/blog-3.jpg" alt=""></a>
                        </div>
                        <div class="blog-details padding-30 border">
                            <h4><a href="front_page/blog.html">We Help Your Time Work For Your Company</a></h4>
                            <p class="blog-meta"><i class="material-icons">event_note</i> <a href="front_page/#">02 February 2016  </a> <i class="material-icons">group</i> <a href="front_page/#">Super User</a></p>
                            <p>Lorem ipsum dolor sit amet, nec in adipiscing purus luctus, urna pellentesque fringilla vel</p>
                            <a class="readmore" href="front_page/blog.html">Continue....</a>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="footer-social-bookmark text-center wow fadeIn">
                            <div class="footer-logo mb50">
                                <a href="front_page/#"><img src="front_page/img/logo.png" alt=""></a>
                            </div>
                            <ul class="social-bookmark">
                                <li><a class="facebook" href="front_page/#"><i class="fa fa-facebook"></i></a></li>
                                <li><a class="twitter" href="front_page/#"><i class="fa fa-twitter"></i></a></li>
                                <li><a class="linkedin" href="front_page/#"><i class="fa fa-linkedin"></i></a></li>
                                <li><a class="pinterest" href="front_page/#"><i class="fa fa-pinterest"></i></a></li>
                                <li><a class="google-plus" href="front_page/#"><i class="fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="front_page/https://colorlib.com" target="_blank">Colorlib</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!--====== SCRIPTS JS ======-->
    <script src="front_page/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="front_page/js/vendor/bootstrap.min.js"></script>

    <!--====== PLUGINS JS ======-->
    <script src="front_page/js/vendor/jquery.easing.1.3.js"></script>
    <script src="front_page/js/vendor/jquery-migrate-1.2.1.min.js"></script>
    <script src="front_page/js/vendor/jquery.appear.js"></script>
    <script src="front_page/js/owl.carousel.min.js"></script>
    <script src="front_page/js/slick.min.js"></script>
    <script src="front_page/js/stellar.js"></script>
    <script src="front_page/js/wow.min.js"></script>
    <script src="front_page/js/jquery-modal-video.min.js"></script>
    <script src="front_page/js/stellarnav.min.js"></script>
    <script src="front_page/js/contact-form.js"></script>
    <script src="front_page/js/jquery.ajaxchimp.js"></script>
    <script src="front_page/js/jquery.sticky.js"></script>
